 ...
 */
IPAddress IP(192, 168, 10, 77);    // *** CHANGE THIS to something relevant for YOUR LAN. ***
IPAddress Subnet(255, 255, 255, 0);   // Subnet mask.
IPAddress DNS(192, 168, 10, 1);    // *** CHANGE THIS to match YOUR DNS server.           ***
IPAddress GW(192, 168, 10, 1);   // *** CHANGE THIS to match YOUR Gateway (router).     ***

//HTTP Method
int    HTTP_PORT   = 8000;
String HTTP_METHOD = "GET"; // or POST
char   HOST_NAME[] = "192.168.10.5";
