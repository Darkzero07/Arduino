 ...
 */
IPAddress eth_IP(192, 168, 31, 77);    // *** CHANGE THIS to something relevant for YOUR LAN. ***
IPAddress eth_MASK(255, 255, 255, 0);   // Subnet mask.
IPAddress eth_DNS(192, 168, 31, 1);    // *** CHANGE THIS to match YOUR DNS server.           ***
IPAddress eth_GW(192, 168, 31, 1);   // *** CHANGE THIS to match YOUR Gateway (router).     ***


// #define RESET_P 26        // Tie the Wiz820io/W5500 reset pin to ESP32 GPIO26 pin.

// const uint16_t localPort = 80;       // HTTP port (Local port for UDP packets  55432.)
